...
public class Lv_1_15 {
	...
	public static void main(String[] args) {
		System.out.println("삼총사");
		Solution15 st = new Solution15();
		
		int[] number = {-2, 3, 0, 2, -5};
		System.out.println(st.solution(number));
		
		int[] number2 = {-3, -2, -1, 0, 1, 2, 3};
		System.out.println(st.solution(number2));
		
		int[] number3 = {-1, 1, -1, 1};
		System.out.println(st.solution(number3));
	}
