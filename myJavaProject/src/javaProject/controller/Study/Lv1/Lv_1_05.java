...
public class Lv_1_05 {
	...
	public static void main(String[] args) {
		System.out.println("바탕화면 정리");
		Solution5 st = new Solution5();
		
		String[] wallpaper = {".#...", "..#..", "...#."};
		System.out.println(Arrays.toString(st.solution(wallpaper)));

		String[] wallpaper2 = {"..........", ".....#....", "......##..", "...##.....", "....#....."};
		System.out.println(Arrays.toString(st.solution(wallpaper2)));

		String[] wallpaper3 = {".##...##.", "#..#.#..#", "#...#...#", ".#.....#.", "..#...#..", "...#.#...", "....#...."};
		System.out.println(Arrays.toString(st.solution(wallpaper3)));

		String[] wallpaper4 = {"..", "#."};
		System.out.println(Arrays.toString(st.solution(wallpaper4)));
	}
